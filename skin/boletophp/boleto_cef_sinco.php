...
$dadosboleto["conta_cedente_caixa"] = "057335"; // ContaCedente do Cliente, sem digito (Somente Números)
$dadosboleto["conta_cedente_dv_caixa"] = ""; // Digito da ContaCedente do Cliente
