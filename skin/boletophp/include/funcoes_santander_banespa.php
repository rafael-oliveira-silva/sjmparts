...
// Captura o CPF/CPNJ do sacado
$order = Mage::getModel('sales/order')->load($this->getRequest()->getParam('order_id'));
$cpfCnpjSacado = Mage::getModel('customer/customer')->load($order->getCustomerId())->getTaxvat();
...
$dadosboleto["cpf_cnpj_sacado"] = 'CPF '.$cpfCnpjSacado;
$dadosboleto["agencia_cedente"] = Mage::getStoreConfig('payment/boleto_bancario/agencia');
