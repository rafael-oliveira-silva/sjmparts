...
$dadosboleto["conta_cedente_caixa"] = "87000000414"; // ContaCedente do Cliente, sem digito (Somente Números)
$dadosboleto["conta_cedente_dv_caixa"] = "3"; // Digito da ContaCedente do Cliente
