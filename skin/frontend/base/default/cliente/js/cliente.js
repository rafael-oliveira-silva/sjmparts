...
function consultarCep(obj){
	...
	var target = jQuery('.customer-address-form').length ? jQuery(obj).parents('.fieldset') : jQuery(obj).parent('div').parent('div').parent('li').parent('ul').parent('fieldset').parent('li');
