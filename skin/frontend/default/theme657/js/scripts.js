...
/********************************************************************* swipe *****************************************************************************/
	   ...
	   jQuery('.swipe').outerHeight(jQuery(window).outerHeight());
	    ...
	    // jQuery(".grid-full > li").hover(
	    //     function() {jQuery(this).find(' > .level-top').stop(true,false).animate({width:'100%', opacity:'1', height:'toggle'}, {duration:200});
	    //     },
	    //     function() { jQuery(this).find(' > .level-top').stop(true,false).slideUp();
	    // });
...
jQuery(document).ready(function() {
	...
	if (jQuery('.container').width() < 766) {
		...
		if(jQuery(".freeslider").length){ 
			 	...
			 	else if (jQuery('.container').width() >= 720){ 
			 		jQuery('.freeslider').bxSlider({
					  captions: true,
					  controls:false,
					  minSlides: 3,
...
jQuery(window).load(function(){
	...
	if(!isMobile) {
		...
		/* fadein_left = jQuery('.list-2 li:nth-child(1)');
		fadein_bottom = jQuery('.list-2 li:nth-child(2)');
		fadein_right = jQuery('.list-2 li:nth-child(3)'); */
		...
		// fadein_footer = jQuery('.footer .footer-col');
		widget_latest = jQuery('.widget-latest ul li');
		...
		// right_animate_3 = TweenMax.staggerFrom(fadein_footer, 0.5, {right:"-100px", alpha: 0, ease:Power1.easeOut}, 0.1);
		right_animate_4 = TweenMax.staggerFrom(widget_latest, 0.5, {right:"-100px", alpha: 0, ease:Power1.easeOut}, 0.1);

		/*if(jQuery(".list-2").length){ 
			var scene_1 = new ScrollScene({
				triggerElement: ".list-2",
				offset: -100
		...
		if(jQuery(".widget-latest").length){ 
			var scene_5 = new ScrollScene({ 
				triggerElement: ".widget-latest",
				offset: -170
				}).setTween(right_animate_4)
				  .addTo(controller)
				  .reverse(false);	
		};
