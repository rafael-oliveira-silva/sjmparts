...
class Smarthint_Recommendation_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getProduct($product){
        ...
        if ($product->getTypeId() != 'configurable' && 
            ($SHProductInfo->SalePrice == 0 || $SHProductInfo->Price == (float) $SHProductInfo->SalePrice)){
        ...
        if ($product->getTypeId() == 'configurable' ){
            ...
            if ($SHProductInfo->SalePrice == 0){
                $SHProductInfo->SalePrice = (float) self::getSimpleProductFinalPrice($product);
            }     
        }
        else if( $product->getTypeId() == 'bundle' && $SHProductInfo->Price == 0 ){
        ...
        //     if ($product->getData('entity_id') == "1361"){
        //         $SHProductInfo->Descrition = $stockItem;
        //     }
        //     if ($stockItem == "0"){
        ...
        if ($images != null){
            ...
            if ( $PrimaryLinkImage != null && ($SHProductInfo->ImageLink == "" || $SHProductInfo->ImageLink == null) ){
                $SHProductInfo->ImageLink = $PrimaryLinkImage->getUrl();
            }else if ($PrimaryLinkImage != null){
            ...
            if ( $SecondLinkImage != null && ($SHProductInfo->ImageLink == "" || $SHProductInfo->ImageLink == null)){
                $SHProductInfo->ImageLink = $SecondLinkImage->getUrl();
            }else if ( $SecondLinkImage != null){
                $empty = "";
                if ( $SecondLinkImage != null){
                    if ( $PrimaryLinkImage != null){
        ...
        if ($SHProductInfo->ImageLink == "" || $SHProductInfo->ImageLink == null) {
    ...
    function getSimpleProductFinalPrice($product){
    ...
    public function getSimpleProductFinalPricee($qty=null, $cfgId)
    {
        $price = 0;
        $childProducts = Mage::getModel('catalog/product_type_configurable')
                            ->getChildrenIds($cfgId);
