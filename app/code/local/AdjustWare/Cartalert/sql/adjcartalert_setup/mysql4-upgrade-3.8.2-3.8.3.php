...
<table border="0" cellpadding="0" cellspacing="0" style="margin:0;">
                ...
                <table style="box-shadow: 0px 2px 10px rgba(0, 0, 0, 0.26); background-color: #FFF;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" style="padding: 20px 35px 35px; text-align: left;">
                            ...
                            {{/depend}}
                            <p style="text-align: center;padding-top: 20px;"><a href="{{var recover_url}}" style="display: inline-block;color: white;background: #71bc37;border: solid #71bc37;border-width: 10px 20px 8px;font-weight: bold;border-radius: 4px; text-decoration: none; font: 14px Helvetica, sans-serif;">RESTORE CART</a></p>
    ...
    <tr style="height: 30px">
        <td align="center" style="padding-top: 35px;">
            If you no longer wish to receive emails from us, click to <a style=" color: #888;text-decoration: none;" href="{{var unsubscribe_url}}">Unsubscribe</a>.
        </td>
    </tr>
</table>
</body>
                ...
                <table style="box-shadow: 0px 2px 10px rgba(0, 0, 0, 0.26); background-color: #FFF;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" style="padding: 20px 35px 35px; text-align: left;">
                            ...
                            <p style="text-align: center;padding-top: 20px;"><a href="{{var recover_url}}" style="display: inline-block;color: white;background: #71bc37;border: solid #71bc37;border-width: 10px 20px 8px;font-weight: bold;border-radius: 4px; text-decoration: none; font: 14px Helvetica, sans-serif;">VALIDATE NOW</a></p>
                            <h3 style="margin: 15px 0px 0px; color: #696060; font: 14px Helvetica, sans-serif; -webkit-text-size-adjust:none; clear: both;">Best regards,<br />
                            The {{var store_name}} team</h3>
                        </td>
                    </tr>
